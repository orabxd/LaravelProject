...
@section('content')
    @include('users.partials.header', [
        ...
        'description' => __('Esta es tu pagina de perfil. Puedes ver el progreso que ha realizado con su trabajo y administrar sus proyectos o tareas asignadas.'),
        'class' => 'col-lg-7'
    ])
                    ...
                    <div class="card-body pt-0 pt-md-4">
                        ...
                        <div class="text-center">
                            ...
                            <div class="h5 font-weight-300">
                                <i class="ni location_pin mr-2"></i>{{ __('Leon, Nicaragua') }}
                            </div>
                            <div class="h5 mt-4">
                                <i class="ni business_briefcase-24 mr-2"></i>{{ __('Gestor de Soluciones - Creative Tim Officer') }}
                            </div>
                            <div>
                                <i class="ni education_hat mr-2"></i>{{ __('Universidad Tecnologica La Salle') }}
                            </div>
                            <hr class="my-4" />
                            <p>{{ __('Ryan - el nombre tomado por Melbourne-raised, con sede en Brooklyn Nick Murphy — escribe, interpreta y graba toda su música.') }}</p>
                            <a href="#">{{ __('Ver mas') }}</a>
                        </div>
                    </div>
                </div>
